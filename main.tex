...
\begin{definition}
    For references the \textbf{deference operator} follows memoery address stoered in reference to the actual value.
\end{definition}
...
Rust cannot perform deref coercion when going from immmutable ref to mutable ref due to the borrowing rules, \textbf{we can only have one mutable reference to a specific piece of data in a specific scope}.
\end{document}
